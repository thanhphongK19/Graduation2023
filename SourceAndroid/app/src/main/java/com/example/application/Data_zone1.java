...
@Entity(tableName = "zone1")
public class Data_zone1 implements Serializable {
    ...
    public Data_zone1(int day, int month, int soil_temperature, int soil_moisture, int air_humidity, int air_temperature) {
        this.day = day;
        this.month = month;
